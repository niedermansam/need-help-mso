  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-stone-950 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-stone-300",
  {
    variants: {
      variant: {
        ...
        primary: "bg-rose-500 text-stone-50 shadow-sm hover:bg-rose-500/90 dark:bg-rose-900 dark:text-stone-50 dark:hover:bg-rose-900/90",
        green: "bg-emerald-600 text-white shadow-sm hover:bg-emerald-700/90 dark:bg-emerald-900 dark:text-stone-50 dark:hover:bg-emerald-900/90 hover:text-white",
      },
      size: {
        ...
        icon: "h-9 w-9",
        xs: 'h-fit w-fit px-2 py-1 text-xs rounded-md'
      },
    },
    defaultVariants: {
      variant: "default",
